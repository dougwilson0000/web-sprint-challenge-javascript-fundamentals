...
//because nestedFunction is a closure and retains access to the variable created in the outer function.
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(array){
    const newArrayLowerCase = array.map(item => {
      const toLower = item.animal_name;
  ...
  */
  ...
  console.log(consume(4, 5, ran))
  console.log(consume('Hello ', 'World', ran))
...
function multiply(a, b){
  ...
  console.log(consume(4,6,multiply));
...
function greeting(a, b){
  ...
  console.log(consume('Douglas', 'Wilson',greeting));
